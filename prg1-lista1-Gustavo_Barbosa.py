...
def dias_perdidos_por_fumar(cigarros, anos):
    ...
    cigarros_ano = cigarros * 365
    cigarros_vida = cigarros_ano * anos
    dias_perdidos = (cigarros_vida * 10) / 1440
