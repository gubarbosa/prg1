...
def calcula_aumento_salario1(salario):
    ...
    salario5 = salario + (salario * 0.05)
    aumento_salario_20 = salario * 0.2
    aumento_salario_15 = salario * 0.15
    aumento_salario_10 = salario * 0.1
    aumento_salario_5 = salario * 0.05

    if salario <= 280:
        return salario, 20, aumento_salario_20, salario20
    elif salario <= 700:
        return salario, 15, aumento_salario_15, salario15
    elif salario <= 1500:
        return salario, 10, aumento_salario_10, salario10
    else:
        return salario, 5, aumento_salario_5, salario5
