...
def converte_hora(horario):
    ...
    return '{}:{} {}'.format(hora, minuto, sufixo)
...
def situacao_aluno(nota1, nota2, nota3, faltas, aulas_ministradas):
    ...
    porcentagem_faltas = faltas / aulas_ministradas
...
def conta_combustivel(qtde_litros, tipo_combustivel, tipo_pagamento):
    ...
    if tipo_combustivel == 'a':
        preco_combustivel = qtde_litros * 3.159
    if tipo_combustivel == 'g':
        preco_combustivel = qtde_litros * 3.739
    else:
        preco_combustivel = qtde_litros * 3.090

    if tipo_pagamento == 'v' or tipo_pagamento == 'd':
        desconto = 0.1 * preco_combustivel
        preco_combustivel -= desconto

    return round(preco_combustivel, 2)
